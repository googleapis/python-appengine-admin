...
from google.cloud.appengine_v1.services.authorized_certificates import (
...
def test_authorized_certificates_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_authorized_certificates_base_transport():
    ...
    with mock.patch(
        "google.cloud.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesTransport.__init__"
    ) as Transport:
...
def test_authorized_certificates_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
