...
def test_firewall_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.appengine_v1.services.firewall.transports.FirewallGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_firewall_base_transport():
    ...
    with mock.patch(
        "google.cloud.appengine_v1.services.firewall.transports.FirewallTransport.__init__"
    ) as Transport:
...
def test_firewall_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.appengine_v1.services.firewall.transports.FirewallTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
