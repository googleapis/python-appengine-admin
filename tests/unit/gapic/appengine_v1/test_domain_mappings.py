...
def test_domain_mappings_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.appengine_v1.services.domain_mappings.transports.DomainMappingsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_domain_mappings_base_transport():
    ...
    with mock.patch(
        "google.cloud.appengine_v1.services.domain_mappings.transports.DomainMappingsTransport.__init__"
    ) as Transport:
...
def test_domain_mappings_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.appengine_v1.services.domain_mappings.transports.DomainMappingsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
