...
class ApplicationsGrpcTransport(ApplicationsTransport):
    ...
    def create_application(
        self,
    ) -> Callable[[appengine.CreateApplicationRequest], operations.Operation]:
    ...
    def update_application(
        self,
    ) -> Callable[[appengine.UpdateApplicationRequest], operations.Operation]:
    ...
    def repair_application(
        self,
    ) -> Callable[[appengine.RepairApplicationRequest], operations.Operation]:
